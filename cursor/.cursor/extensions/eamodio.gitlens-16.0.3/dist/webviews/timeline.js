...
`;var Pr=Object.defineProperty,Sr=Object.getOwnPropertyDescriptor,Ar=(e,t,o,r)=>{for(var n,s=r>1?void 0:r?Sr(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(s=(r?n(t,o,s):n(s))||s);return r&&s&&Pr(t,o,s),s};let Rr=class extends lit_element_r{constructor(){super(...arguments),this.type="info"}get hasPromo(){return null!=this.promo}render(){if(!this.promo)return;const e=this.renderPromo(this.promo);return e?"link"===this.type?Ot`<a
				class="link"
			...
			>`:Ot`<p class="promo">${e}</p>`:void 0}renderPromo(e){switch(e.key){case"cybersale24":return Ot`<span class="content${"link"===this.type?Bt:" muted"}"
				...
				>`;default:return e.key,Bt}}};Rr.styles=[Ke`
			:host {
				display: block;
			}
		...
		`],Ar([qt({type:Object})],Rr.prototype,"promo",2),Ar([qt({reflect:!0,type:String})],Rr.prototype,"type",2),Ar([qt({reflect:!0,type:Boolean,attribute:"has-promo"})],Rr.prototype,"hasPromo",1),Rr=Ar([Nt("gl-promo")],Rr);var Dr=Object.defineProperty,Tr=Object.getOwnPropertyDescriptor,Lr=(e,t,o,r)=>{for(var n,s=r>1?void 0:r?Tr(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(s=(r?n(t,o,s):n(s))||s);return r&&s&&Dr(t,o,s),s};let Er=class extends lit_element_r{firstUpdated(){"alert"===this.appearance&&queueMicrotask((()=>this.button.focus()))}render(){if(null==this.state)return void(this.hidden=!0);this.hidden=!1;const e="alert"===(this.appearance??"alert")?"alert":Bt,t=this.state?$r(this.state,"gate"):void 0;switch(this.state){case c.VerificationRequired:return Ot`
					<slot name="feature"></slot>
					<p class="actions">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Or(wr.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Or(wr.PlusValidate,this.source)}"
							><code-icon icon="refresh"></code-icon
						></gl-button>
					</p>
					<p>You must verify your email before you can continue.</p>
				`;case c.Community:case c.ProPreviewExpired:return this.featurePreview&&!function(e){const t=e.usages;if(null==t||0===t.length)return!1;const o=(new Date(t[t.length-1].expiresOn).getTime()-(new Date).getTime())/xr;return t.length>3||3===t.length&&o<=0||o>=24}(this.featurePreview)?Ot`${this.renderFeaturePreview(this.featurePreview)}`:Ot`<slot name="feature"></slot>
					<p>
					...
					<p class="actions-row">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Or(wr.PlusSignUp,this.source)}"
							>&nbsp;Try GitLens Pro&nbsp;</gl-button
						><span
							>or
							<a href="${Or(wr.PlusLogin,this.source)}" title="Sign In"
								>sign in</a
							></span
						>
					</p>
					...
					<p class="actions-row">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Or(wr.PlusUpgrade,this.source)}"
					...
					<p class="actions-row">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Or(wr.PlusReactivateProTrial,this.source)}"
							>Continue</gl-button
						><span
							>or
							<a href="${Or(wr.PlusLogin,this.source)}" title="Sign In"
				...
				<p>
					...
					repos, or
					<a href="${Or(wr.PlusLogin,this.source)}" title="Sign In">sign in</a>.<br />
					${"alert"!==t?Ot`<br />`:""} For full access to all GitLens Pro features,
					<a href="${Or(wr.PlusSignUp,this.source)}"
			...
			<p class="actions-row">
				...
				><span
					>or
					<a href="${Or(wr.PlusLogin,this.source)}" title="Sign In">sign in</a></span
				>
			</p>
			<p>
		...
		`}renderFeaturePreviewStep(e,t){if("graph"===e.feature)switch(t){case 1:return Ot`<p>Try Commit Search</p>
						...
						`;default:return Ot`<slot name="feature"></slot>`}return Ot`<slot name="feature"></slot>`}renderPromo(e){return Ot`<gl-promo .promo=${e}></gl-promo>`}};function Or(e,t){return`command:${e}${t?`?${encodeURIComponent(JSON.stringify(t))}`:""}`}Er.styles=[_r,Ke`
			:host {
		...
		`],Lr([Jt("gl-button")],Er.prototype,"button",2),Lr([qt({type:Object})],Er.prototype,"featurePreview",2),Lr([qt({type:String})],Er.prototype,"featurePreviewCommandLink",2),Lr([qt({type:String})],Er.prototype,"appearance",2),Lr([qt()],Er.prototype,"featureWithArticleIfNeeded",2),Lr([qt({type:Object})],Er.prototype,"source",2),Lr([qt({attribute:!1,type:Number})],Er.prototype,"state",2),Lr([qt({type:String})],Er.prototype,"webroot",2),Er=Lr([Nt("gl-feature-gate-plus-state")],Er);var Fr=Object.defineProperty,Br=Object.getOwnPropertyDescriptor,Ir=(e,t,o,r)=>{for(var n,s=r>1?void 0:r?Br(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(s=(r?n(t,o,s):n(s))||s);return r&&s&&Fr(t,o,s),s};let Mr=class extends lit_element_r{render(){if(!this.visible||null!=this.state&&(null!=(e=this.state)&&(e===c.Paid||e===c.ProPreview||e===c.ProTrial)))return void(this.hidden=!0);var e;const t=this.appearance??"editor"===(document.body.getAttribute("data-placement")??"editor")?"alert":"welcome";return this.hidden=!1,Ot`
			<section>
				<slot></slot>
		...
		</sl-popup>`}};Nr.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},Nr.styles=Ke`
		:host {
			--hide-delay: 0ms;
			--show-delay: 500ms;
	...
	`,Vr([Jt("#popover")],Nr.prototype,"body",2),Vr([Jt("sl-popup")],Nr.prototype,"popup",2),Vr([qt({reflect:!0})],Nr.prototype,"placement",2),Vr([qt({type:Object})],Nr.prototype,"anchor",2),Vr([qt({reflect:!0,type:Boolean})],Nr.prototype,"disabled",2),Vr([qt({type:Number})],Nr.prototype,"distance",2),Vr([qt({reflect:!0,type:Boolean})],Nr.prototype,"open",2),Vr([qt({reflect:!0,type:Boolean})],Nr.prototype,"arrow",2),Vr([qt({type:Number})],Nr.prototype,"skidding",2),Vr([qt()],Nr.prototype,"trigger",2),Vr([qt({type:Boolean})],Nr.prototype,"hoist",2),Vr([Wr("open",{afterFirstUpdate:!0})],Nr.prototype,"handleOpenChange",1),Vr([Wr(["distance","hoist","placement","skidding"])],Nr.prototype,"handleOptionsChange",1),Vr([Wr("disabled")],Nr.prototype,"handleDisabledChange",1),Nr=Vr([Nt("gl-popover")],Nr);var Gr=Object.defineProperty,jr=Object.getOwnPropertyDescriptor,qr=(e,t,o,r)=>{for(var n,s=r>1?void 0:r?jr(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(s=(r?n(t,o,s):n(s))||s);return r&&s&&Gr(t,o,s),s};let Qr=class extends lit_element_r{constructor(){super(...arguments),this.cloud=!1,this.placement="bottom",this.preview=!1}get daysRemaining(){return null==this.subscription?0:C(this.subscription,"days")??0}get state(){return this.subscription?.state}render(){return Ot`
		...
		`}renderBadge(){const e=this.preview?"Preview":"Pro";if(null!=this.subscription){if(this.state===c.VerificationRequired)return Ot`${e} <code-icon class="badge-icon" icon="warning" size="10"></code-icon>`;if(P(this.subscription)||this.cloud&&null!=this.subscription.account)return Ot`${e} <code-icon class="badge-icon" icon="check" size="10"></code-icon>`;if(null!=(t=this.state)&&(t===c.ProPreview||t===c.ProTrial))return Ot`${e} <code-icon class="badge-icon" icon="clock" size="10"></code-icon>`}var t;return e}renderPopoverHeader(){const e=Ot`<span class="popup-title">${this.preview?"Preview feature":"Pro feature"}</span>`;return this.state===c.Paid?Ot`<div class="popup-header">${e}</div>`:this.cloud?this.preview?Ot`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires GitLens Pro for use on privately-hosted repos</span>
					...
					<gl-tooltip hoist content="Show Account view">
						<a href="${Jr(wr.ShowAccountView,void 0)}"
					...
					<div class="actions">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Jr(wr.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							appearance="secondary"
							density="tight"
							href="${Jr(wr.PlusValidate,this.source)}"
							><code-icon icon="refresh"></code-icon
						></gl-button>
					...
					<div class="actions center">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Jr(wr.PlusReactivateProTrial,this.source)}"
			...
			<gl-button
				appearance="primary"
				density="tight"
				href="${Jr(wr.PlusSignUp,this.source)}"
				>Start ${a}-day Pro Trial</gl-button
			>
			&nbsp;or <a href="${Jr(wr.PlusLogin,this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(e){const t=$r(this.state,"badge");return Ot`<div class="actions">
			${e??Bt}
			<gl-button
				appearance="primary"
				density="tight"
				href="${Jr(wr.PlusUpgrade,this.source)}"
				>Upgrade to Pro</gl-button
			>
			${this.renderPromo(t)}
		</div>`}renderPromo(e){return Ot`<gl-promo .promo=${e}></gl-promo>`}};function Jr(e,t){return`command:${e}${t?`?${encodeURIComponent(JSON.stringify(t))}`:""}`}Qr.styles=[ai,li,Ke`
			:host {
				/* position: relative; */
				display: inline-block;
